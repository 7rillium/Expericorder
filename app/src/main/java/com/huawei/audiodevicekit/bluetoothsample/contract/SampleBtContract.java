...
public interface SampleBtContract {
    ...
    interface Presenter extends IPresenter {
        ...
        void speechStart(String[] textguide);

        void nextLab(String[] textguide);

        void lastLab(String[] textguide);

        void nextStep(String[] textguide);

        void lastStep(String[] textguide);

        void speechStartStop(String[] textguide);

        void btnVoice(EditText mResultText);
