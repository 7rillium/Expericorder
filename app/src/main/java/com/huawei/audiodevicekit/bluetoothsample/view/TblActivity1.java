...
public class TblActivity1 extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        y=0;
        status=0;
        List<Entry1> list = new ArrayList<Entry1>();
        list.add(new Entry1());
        list.add(new Entry1());
        tableListView = (ListView) findViewById(R.id.list);
        TblAdapter1 adapter = new TblAdapter1(this, list);
    ...
    private void btnVoice() {
        ...
        dialog.setParameter(SpeechConstant.VAD_EOS, "5000");
    ...
    private void printResult(RecognizerResult results) {
        ...
        mResultText.setText("");
        String[] res_array = res.split(" |,|，|。");//根据停顿将各格内容隔开
        for(String content:res_array){
            WriteTable(content);
            if(x>=table_length){
                break;
            }
        ...
        if(x>=table_length){//表格填满后保存文件
            ...
            // 跳转到下一页面
            Intent intent = new Intent(this,TblActivity2.class);
